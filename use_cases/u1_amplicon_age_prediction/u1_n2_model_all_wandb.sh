...
#SBATCH --job-name="u1_all_config_w_nest2_wandb"
...
# ! USER SETTINGS HERE
# -> config file to use
CONFIG="config/u1_all_config_w_nest2_wandb.json"
...
LOGS_DIR="/cluster/work/bokulich/adamova/ritme_example_runs/u1_all_config_w_nest2_wandb"
# -> path to data splits
