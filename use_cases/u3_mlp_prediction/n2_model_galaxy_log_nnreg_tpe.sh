...
#SBATCH --job-name="u3_galaxy_log_nnreg_tpe"
#SBATCH -A SLURM_SHARE
#SBATCH --nodes=1
#SBATCH --cpus-per-task=100
#SBATCH --mem-per-cpu=4096
#SBATCH --time=119:59:59
#SBATCH --output="/cluster/work/bokulich/adamova/ritme_usecase_runs_final_time/logs/%x_out.txt"
...
# ! USER SETTINGS HERE
# -> config file to use
CONFIG="config/u3_galaxy_log_nnreg_tpe.json"
...
LOGS_DIR="/cluster/work/bokulich/adamova/ritme_usecase_runs_final_time"
# -> path to data splits
