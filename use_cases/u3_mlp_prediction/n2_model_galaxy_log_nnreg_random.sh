...
#SBATCH --job-name="u3_galaxy_log_nnreg_random"
#SBATCH -A es_bokulich
#SBATCH --nodes=1
#SBATCH --cpus-per-task=100
#SBATCH --mem-per-cpu=4096
#SBATCH --time=119:59:59
#SBATCH --output="/scratch/adamova/ritme_usecase_runs_final_time/logs/%x_out.txt"
...
# ! USER SETTINGS HERE
# -> config file to use
CONFIG="config/u3_galaxy_log_nnreg_random.json"
...
LOGS_DIR="/scratch/adamova/ritme_usecase_runs_final_time"
# -> path to data splits
