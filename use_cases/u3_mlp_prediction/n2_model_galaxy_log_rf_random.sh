...
#SBATCH --job-name="u3_galaxy_log_rf_random"
...
# ! USER SETTINGS HERE
# -> config file to use
CONFIG="config/u3_galaxy_log_rf_random.json"
...
LOGS_DIR="/cluster/project/bokulich/adamova/ritme_usecase_runs_final_time"time"
# -> path to data splits
